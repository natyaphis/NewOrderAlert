...
L["SUPPRESS_MYTHIC_PLUS"] = "Suppress notifications in 5-player dungeons"
L["SUPPRESS_RAID"] = "Suppress notifications in raids"
L["SUPPRESS_ARENA"] = "Suppress notifications in arenas"
L["SUPPRESS_BATTLEGROUND"] = "Suppress notifications in battlegrounds"
L["REST_AREA_ONLY"] = "Notify only in rest areas"
